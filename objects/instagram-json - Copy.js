...
export const InstagramSingleContainer = ({id, render, settings}) => {
  console.log( 'single container props' );
  console.log( id );
  const urlObject = new IGPhotoUrl( id );
  console.log( urlObject );
  const apiUrl = urlObject.apiUrl;
  const createJsonObject = (json) => {
    return new IGSingleJson( json );
  }
  return(
    <InstagramGenericContainer
      apiUrl={apiUrl}
...
export const InstagramUserContainer = ({username, render, settings}) => {
  console.log( 'user container props' );
  console.log( username );
  console.log( render );
  const urlObject = new IGUserUrl( username );
  const apiUrl = urlObject.apiUrl;
  const createJsonObject = (json) => {
    return new IGUserJson( json );
  }
  return(
    <View>

export default function Rectangle(width = 0, height = 0, x = 0, y = 0) {
    ...
    Object.defineProperty(this, 'width', {
        ...
        set(value) {
            ...
            //could screw things up if used improperly
            //but assume x is fixed and x2 changes
            this.x2 = value + this.x1;
        }
    });
...
export function ObjectToRectangle(object) {
  let rectangle = new Rectangle();
  Object.keys(object).forEach(
    key => rectangle[key] = object[key]
  );
  return rectangle;
}
